...
<body>
	...
	<div id="main-wrapper">
		<center><h2>Welcome Alumni <?php echo $_SESSION['usn']; ?></h2></center>
	...
	echo '<p>';
		...
		echo '<form method="post" action="alumnisubmitted.php">';
...
echo '<br><br>';
echo '<a href = "alumnisubmitted.php"> <button name="submit" class = "login_button" type="submit">Submit</button> </a>';
echo '</form>';
echo '</div>';
